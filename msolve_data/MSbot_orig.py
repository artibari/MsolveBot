...
def getResponse(input_statement,sessionId,response,cont_id):
	...
	print("contttttttttttttttttttttttttt id ------------------- ".format(cont_id))
	
	print("corrrrrrrrrrrrrrrrrrrrp id ------------------- ".format(Corporate_ID))
	...
	#elif chat_stage == "asset_dropdown":
	#	asset = input_statement
	#	replyVal = "Alright.</br>Before I raise a ticket, You can elaborate your problem or add specific instructions as notes for my team."
	#	replyJson = {"reply":replyVal}
	#	replyJson.update({"chat_type":chat_type})
	#	note_flag = True
	#	chat_stage = "ticket_confirmation"
...
def application(environ, start_response):
	...
	if poll_flag == "true":
		...
		print("appplicationnnnnnnnnnnnnnnnnn ------------------ cont id-------- ".format(cont_id))
